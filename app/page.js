        ...
        <div className="max-w-5xl mx-auto pt-8 px-4 pb-16">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="md:w-1/2 bg-gradient-to-br from-orange-600 via-pink-600 to-blue-700 text-white p-6 rounded-lg shadow-lg">
              <h2 className="text-2xl font-bold mb-4 text-white">A safer social media for schools</h2>
              
              <div className="space-y-3 text-sm">
                <div className="flex items-start">
                  <div className="bg-white bg-opacity-20 p-1.5 rounded-full mr-3 flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <p><span className="font-semibold">School-based discovery</span> — Students can only find classmates from their own school</p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p><span className="font-semibold">Healthy limits</span> — Daily post limits and once-a-day content releases</p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p><span className="font-semibold">Thoughtful features</span> — Image quality reduction and randomized like counts</p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p><span className="font-semibold">No addictive elements</span> — No AI, messaging, notifications, algorithmic feeds, infinite scrolling, or streak counts</p>
                </div>
              </div>
              
              <div className="mt-5 pt-4 border-t border-white border-opacity-30">
                <p className="font-medium">Designed to help students develop healthy digital habits</p>
              </div>
            </div>
