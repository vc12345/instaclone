...
export const recentActivity = {
  ...
  // Maximum age of posts to show in hours (for error message only)
  maxAgeHours: 168,
};
...
export const uploadLimits = {
  ...
  // Maximum number of posts a user can store in total
  // When this limit is reached, the oldest post will be deleted on new uploads
  maxTotalPosts: 99,
};
